...
char* get_current_date_time(I2C_HandleTypeDef *hi2c2) {
...
while (1)
  {
		// L?y chu?i th?i gian hi?n t?i
        char* datetime_str = get_current_date_time(&hi2c2);

        // Xu?t chu?i th?i gian ra màn hình LCD
        sendlcd(datetime_str);
